...
mod tests {
    ...
    fn test_shunting_yard() {
        ...
        let expected_ast = Statement::Expression(
            Expression::Constant(Constant::Default(dapa_types::Value::U64(25)))
        );
    ...
    fn test_shunting_yard_nested() {
        ...
        // Build the expected AST
        let expected_ast = Statement::Expression(
            Expression::Constant(Constant::Default(dapa_types::Value::U64(25 - 8)))
        );
    ...
    fn test_shunting_yard_constant() {
        ...
        // Build the expected AST
        let expected_ast = Statement::Expression(
            Expression::Constant(Constant::Default(dapa_types::Value::U64(25+255)))
        );
